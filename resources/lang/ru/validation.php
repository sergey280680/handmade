...
return [
    ...
    'captcha'              => 'Введите корректно символы с картинки.',
    ...
    */
    ...
    'custom' => [
        'content' => [
            'regex' => 'Текстовое поле содержит пустые или недопустимые HTML-теги.',
            'required' => 'Поле для сообщения не должно быть пустым!',
        ],
        'text_file' => [
            'max' => [
        ...
        'image' => [
            'dimensions' => 'Файл должен иметь следующий формат: jpg,png,gif ',
        ]
